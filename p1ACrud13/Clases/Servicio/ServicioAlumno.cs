...
{
    public class ServicioAlumno : ServicioAlumnoBase
    {
        ...
        public MdAlumnos ObtenerAlumno(string carnet)
        {
            ...
            if (resp.Rows.Count > 0)
            {
                ...
                {
                    alu.idAlumno = Convert.ToInt32(item["idAlumnos"]);
        ...
        {
            string instruccion = $"update tb_alumnos set nombre = '{alu.nombre}',correo = '{alu.correo}',clase = '{alu.clase}',seccion= '{alu.seccion}'  carnet='{alu.carnet}', paricial1='{alu.parcial1}', parcial2='{alu.parcial2}' where parcial3='{alu.parcial3}'";
            return cone.EjecutarSQLDirecto(instruccion);
        }
